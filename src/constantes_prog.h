#ifndef __CONSTANTES_PROG_H__
#define __CONSTANTES_PROG_H__

#define MAX_CHAR_INT 20
#define MAX_SMALL_CHAR 5
#define MAX_CHAR 100

#define FIC_SON_WAW_CLAVIER "./Son_clavier.wav"
...
#define COLOR_HISTORIQUE      BLACK
#define BG_COLOR_HISTORIQUE   LIGHT_GREEN
#define BORDER_COLOR_HISTORIQUE LIGHT_BLUE
